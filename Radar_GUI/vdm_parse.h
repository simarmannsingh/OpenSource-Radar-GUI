...
typedef struct {
    ...
    unsigned char   regional;          //!< 8 bits   : Regional Bits
    char            raim;              //!< 1 bit    : RAIM Flag
    char            virtuale;           //!< 1 bit    : Virtual/Pseudo AtoN Flag
    char            assigned;          //!< 1 bit    : Assigned Mode Flag
...
int  pos2dmm( long latitude, long longitude, short *lat_dd, double *lat_min, short *long_ddd, double *long_min );
